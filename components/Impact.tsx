      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-6">
          {impacts.map((item) => {
            ...
            return (
              <div key={item.title}
                className="group bg-white border border-border rounded-2xl p-6 lg:p-7 hover:shadow-lg hover:-translate-y-1 hover:border-[#F5A623]/30 transition-all duration-300">
