            ...
            <div className="relative flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
              ...
              <div className="flex flex-col items-center gap-3 flex-shrink-0">
                <button
                  ...
                  className="relative inline-flex items-center gap-2 rounded-full font-bold text-sm text-white px-7 lg:px-8 overflow-hidden group transition-all duration-300"
                  style={{ height: "48px", background: "#0a0a0a", border: "1px solid rgba(255,255,255,0.15)", boxShadow: "0 4px 20px rgba(245,166,35,0.45)" }}>
