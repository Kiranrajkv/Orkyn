    ...
    <section className="py-20 lg:py-28 bg-[#0a0a0a] text-white relative overflow-hidden" aria-label="Before and after Orkyn">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4">
          {stats.map((s, i) => (
            <div key={i} className="text-center py-5 lg:py-6 px-4 rounded-2xl border border-white/8 bg-white/3 hover:border-[#F5A623]/30 hover:bg-[#F5A623]/5 transition-all duration-300 cursor-default">
