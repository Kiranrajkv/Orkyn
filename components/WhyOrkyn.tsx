  ...
  return (
    <section className="py-20 lg:py-28 bg-[#FAFAFA]" aria-label="Why choose Orkyn">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <StaggerChildren className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6 items-stretch" stagger={80}>
          {pillars.map((pillar) => {
            const Icon = pillar.icon;
            return (
              <div key={pillar.title}
                className="group bg-white border border-border rounded-2xl p-7 hover:border-[#F5A623]/30 hover:shadow-lg transition-all duration-300 flex flex-col h-full">
