...
const services = [
  {
    ...
    category: "Systems and Development",
          ...
          {services.map((service) => {
            ...
            return (
              <Link key={service.slug} href={service.href}
                className="group bg-white border border-border rounded-2xl p-7 lg:p-8 transition-all duration-300 hover:-translate-y-1.5 cursor-pointer block"
              ...
              >
                ...
                <div className="inline-flex items-center gap-1.5 text-sm font-semibold text-foreground group-hover:gap-3 transition-all duration-200">
