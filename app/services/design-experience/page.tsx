...
export const metadata: Metadata = {
  title: { absolute: "UX, UI & Product Design Agency | Orkyn" },
  description:
    "UX design, UI design, product design and design systems for B2B SaaS and enterprise products. Serving UK, UAE, India, USA and Europe.",
  ...
  keywords: [
    ...
    "design and digital agency India",
    ...
    "UX design agency Sheffield",
    "UX design agency Bristol",
    "UX design agency Edinburgh",
    "UX design agency Cambridge",
    "UX design agency Belfast",
    "UX design agency New York",
    "UX design agency San Francisco",
    "UX design agency Sydney",
    "UX design agency Singapore",
    "UX design agency Dublin",
    "UX design agency Toronto",
    "UX design agency Berlin",
    "UX design agency Amsterdam",
    "UX design agency Noida",
    "UX design agency Gurgaon",
    "UX design agency Ahmedabad",
    "UX design agency Kolkata",
    "design agency Ajman",
    "design agency Sharjah",
    "design agency Abu Dhabi",
    "UX for fintech",
    "UX for healthtech",
    "UX for edtech",
    "UX for proptech",
    ...
    "UX for marketplaces",
    "UX for eCommerce",
    "UX for SaaS startups",
    "UX for B2B SaaS",
    "UX for enterprise dashboards",
    "design audit services",
    "UX audit services",
    "heuristic evaluation services",
    "design system audit",
    "MVP design services",
    ...
    "design for CMOs",
    "design for startups",
    "design for scale-ups",
    "design for Series A startups",
    "design for enterprise products",
    "design for B2B platforms",
    "fixed price design services",
    "monthly design retainer",
    "design and front-end engineering",
    "design and React development",
    "Figma to code services",
    "design to development handoff",
    "accessibility audit WCAG",
    "WCAG 2.2 compliance design",
    "inclusive design services",
    "mobile-first design agency",
    "responsive design agency",
    "dashboard design agency",
    "admin panel design",
    "data visualisation design",
    "design ops for SaaS teams",
    "design tokens consultancy",
    "Storybook component library",
    "design system in Figma",
    "alternative to in-house design team",
    "alternative to design freelancers",
  ],
  openGraph: {
    type: "website",
    title: "UX, UI & Product Design Agency | Orkyn",
    description: "UX, UI and design systems for B2B SaaS and enterprise products. UK, UAE, India, USA, Europe.",
    images: [{ url: "/og-image.svg" }],
  },
};

const PAGE_URL = `${SITE_URL}/services/design-experience`;

const serviceSchema = buildServiceSchema({
  name: "UX, UI and Product Design",
  description:
    "User experience design, user interface design, product design, design systems, interaction design and brand design for B2B SaaS, enterprise products and digital platforms. UK, UAE, India, USA, Europe.",
  url: PAGE_URL,
  serviceType: [
    "UX Design",
    "UI Design",
  ...
  keywords:
    "UX design agency, UI design agency, product design agency, design systems agency, interaction design agency, brand design agency, SaaS UX design, B2B product design, enterprise UX design, creative digital agency, branding and marketing agency, UX UI design agency UK, UX design agency London, product design agency London, design agency Manchester, branding agency Liverpool, UX UI design Dubai, design agency Dubai, branding agency Dubai, design agency UAE, product design agency India",
});

const designSystemsServiceSchema = buildServiceSchema({
  id: `${PAGE_URL}#service-design-systems`,
  name: "Design Systems for SaaS and Enterprise Products",
  description:
    "Scalable design systems for SaaS and enterprise products. Component libraries, design tokens, accessibility patterns and engineering handover documentation built so product teams scale without losing visual consistency.",
  url: PAGE_URL,
  serviceType: [
    "Design Systems",
  ...
  keywords:
    "design systems agency, design system development, SaaS design system, component library, design tokens, SaaS UX design, B2B product design, enterprise design system, design systems UK, design systems Dubai, design systems India, scalable design system, design system consultancy",
});

const brandDesignServiceSchema = buildServiceSchema({
  id: `${PAGE_URL}#service-brand-design`,
  name: "Brand and Visual Identity Design",
  description:
    "Brand strategy, visual identity, logo design and brand systems for technology businesses and B2B SaaS companies. Cohesive brand presence across every product and marketing surface.",
  url: PAGE_URL,
  serviceType: [
    "Brand Design",
  ...
  keywords:
    "brand design agency, visual identity, branding agency, brand strategy, logo design, brand systems, branding UK, branding Dubai, branding India, creative digital agency, branding and marketing agency, brand positioning agency, digital brand strategy agency, performance branding agency",
});

const breadcrumbSchema = buildBreadcrumbSchema([
  { name: "Home", url: SITE_URL },
  { name: "Services", url: `${SITE_URL}/#services` },
  { name: "Design and Experience", url: PAGE_URL },
]);
...
export default function DesignExperiencePage() {
  return (
    <div className="pt-16">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={jsonLdScript(designSystemsServiceSchema)} />
      <script type="application/ld+json" dangerouslySetInnerHTML={jsonLdScript(brandDesignServiceSchema)} />
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn>
            ...
            <ServiceFAQ accentColor="#a855f7" questions={[
              ...
              { q: "What is the difference between UX and UI design?", a: "UX design focuses on how a product works, user journey, information architecture and flow. UI design focuses on how it looks, visual style, components and interactions. We deliver both together so the experience and the interface are designed as a single coherent system." },
              { q: "Do you create design systems?", a: "Yes. Every design project includes a scalable component library and design system that keeps your brand consistent across every product surface. Your engineering team builds faster and your design stays coherent as the product grows." },
              ...
              { q: "Do you offer UX and product design services in the UK?", a: "Yes. We work with clients across London, Manchester, Birmingham, Leeds and the wider UK as a UX UI design agency and product design partner. Engagements are remote-first with on-site workshops when useful." },
              { q: "Do you offer UX design services in Dubai or the UAE?", a: "Yes. We deliver UX design, UI design and product design for businesses in Dubai, Abu Dhabi and across the UAE. We work in both English and at-glance Arabic-aware interfaces when required." },
              { q: "Do you have a design team in India?", a: "Yes. Our India team delivers UX research, UI design and product design as part of every engagement. Available as a product design agency for clients in India and globally." },
              { q: "Can you build a design system for our SaaS product?", a: "Yes. Design systems for SaaS are one of our most common engagements, component libraries, tokens, accessibility patterns, dark mode variants and engineering handover documentation built so your team scales the product without losing visual consistency." },
              { q: "Do you do product design for B2B startups and enterprises?", a: "Yes. Most of our work is B2B SaaS and enterprise product design, admin platforms, internal tools, data dashboards, complex workflow software and customer-facing B2B products that need to feel premium and operate flawlessly." },
              { q: "Are your designs accessible (WCAG compliant)?", a: "Yes. Accessibility is built into every design rather than added at the end. We design to WCAG standards as standard, colour contrast, focus states, keyboard navigation, semantic structure and screen reader behaviour." },
            ]} />
          </FadeIn>
        </div>
      </section>
